...
11/12 | 11/14	| 20, 21 | Introduction to “Generalized” Linear Regression - Non-normal and/or Non-continuous outcomes; e.g. binary outcomes via Logistic Regression; brief intro to Poisson, Negative Binomial and other distributions that can be fit to your outcomes | H06 due 12/05
11/19 | 11/21 (on own)	| 22, -- | Modeling Time/Longitudinal Data: 2 Time points (PRE-POST); Paired t-tests and Wilcoxon Rank Sum Test | 
11/26 | 11/28 | 23, 24 | Repeated Measures ANOVA (pros and cons), Data structure (restructuring); correlated time points; considerations of Missing Data;  More on longitudinal data modeling; intro to Multilevel “Mixed” Models (nested, clustered, correlated data structures) | H07 due 12/10
...
. | . |	--, -- | FINAL PROJECT (Milestone #3) DUE NO LATER THAN 12/17/2018 | 	Final Project
