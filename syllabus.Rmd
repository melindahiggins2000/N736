...
## _**Syllabus - Updated 10/31/2018**_
...
9/10	| 9/12	| 3, 4 |Creating new variables; recoding; data cleaning and data formats; summarizing your data; Data Wrangling	| 
9/17 | 9/19	| 5, 6  | Univariate, Descriptive Statistics	| H02 due 9/26
9/24 | 9/26	| 7, 8  | Homework 01 Review and Univariate Statistics (tests and graphics) - continued	| 
10/1| 10/3	| 9, 10 | Bivariate Stats & Introduction to Bootstrapping & Missing Data	| H03 due 10/10 & PROJECT Milestone 1 due 10/17
--- | 10/10	| --, 11 | Building Models; and Introduction to regression/model diagnostics | 
10/15	| 10/17	| 12, 13 | More than 2 groups: Introduction to One-way ANOVA and Simple Linear Regression; Multivariate Linear Regression –  Understanding the impact of the Correlation Matrix (confounding, multicollinearity, sequential regression); reviewing multicollinearity and regression assumptions – model building and variable selection methods| H04 due 10/24
10/22 | 10/24	| 14, 15 | Regression Diagnostics Review for Homework 4; More on Model Building Multivariate Regression and Variable Selection | 
10/29 | 10/31	| 16, 17 | Power, Sample Size and Effect Sizes; Understanding Factors and Covariates & Evaluating “Theoretical” Covariates (in ANOVA and Regression) and Interaction Effects (Moderation and Testing Homogenity of Slopes assumptions) | H05 due 11/14
11/05	| 11/07	| 18, 19 | More on modeling covariates, interactions and covariates; ANCOVA - Analysis of Covariance; More than 2: Introduction to Two-way/multivariate ANOVA - blending regression/ANOVA and the GLM (General Linear Model)	| 
11/12 | 11/14	| 20, 21 | Introduction to “Generalized” Linear Regression - Non-normal and/or Non-continuous outcomes; e.g. binary outcomes via Logistic Regression; brief intro to Poisson, Negative Binomial and other distributions that can be fit to your outcomes | H06 due 11/28
11/19 | 11/21 (on own)	| 22, -- | Modeling Time/Longitudinal Data: 2 Time points (PRE-POST); Paired t-tests and Wilcoxon Rank Sum Test | 
11/26 | 11/28 | 23, 24 | Repeated Measures ANOVA (pros and cons), Data structure (restructuring); correlated time points; considerations of Missing Data;  More on longitudinal data modeling; intro to Multilevel “Mixed” Models (nested, clustered, correlated data structures) | H07 due 12/05
12/3 | 12/05	| 25, 26 | Introduction to “Psychometrics” (Survey/Questionnaire) Instruments, Scoring, missing/skipped items, Factor Analysis, Reliability; Brief Overview of Structural Equation Modeling: Mediation and Moderation; Correlated and Non-Normal Outcomes: MANOVA, Discriminant Analysis; Survival Analysis	| Milestone 2 due 12/10
